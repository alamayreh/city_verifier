...
def parse_args():
    ...
    args.add_argument(
        ...
        default=Path(
            "/data/omran/cities_data/models/resnet101_64_sigmoid_Nonlinearty_freezeBackbone/221029-0428/ckpts/epoch_568.ckpt"),
    ...
    args.add_argument(
        ...
        default=Path(
            "/data/omran/cities_data/models/resnet101_64_sigmoid_Nonlinearty_freezeBackbone/221029-0428/tb_logs/version_0/hparams.yaml"),
    ...
    args.add_argument(
        ...
        default=Path(
            '/data/omran/cities_data/models/resnet101_64_embedding_25600_freezeBackbone/221028-1010/ckpts/epoch_183.ckpt'),
        help="Checkpoint to already trained model (*.ckpt)",
    )
    args.add_argument(
        "--hparams_contrastive",
        ...
        default=Path(
            '/data/omran/cities_data/models/resnet101_64_embedding_25600_freezeBackbone/221028-1010/tb_logs/version_0/hparams.yaml'),
        help="Path to hparams file (*.yaml) generated during training",
    )
    args.add_argument(
        "--image_dir",
...
class SiameseNetworkDataset_one_class(Dataset):
    ...
    def __init__(self, imageFolderDataset, transform=None, city=None, num_pairs=40000):
...
def test_dataloader(image_dir, batch_size, num_workers, city_class):
    ...
    dataset = SiameseNetworkDataset_one_class(
        imageFolderDataset=DatasetFolder_test, transform=tfm_test, city=city_class, num_pairs=40000)
...
if __name__ == '__main__':
    ...
    test_dataloader = test_dataloader(
        args.image_dir, args.batch_size, args.num_workers, args.city_class)
    ...
    if (sigmoid == True):
        ...
        print(
            f'acc skealrn just to check {accuracy_score(y_true, y_pred) * 100 }')
    ...
    if (sigmoid != True):
        ...
        for im1, im2, target in tqdm(test_dataloader):
            ...
            correct_cosine += pred_cosine.eq(
                target.view_as(pred_cosine)).sum().item()
