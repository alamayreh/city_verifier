...
from utils import *
from train_sigmoid import SiameseNetwork 
...
def parse_args():
    ...
    args.add_argument(
        "--checkpoint",
        type=Path,
        default=Path("/data/omran/cities_data/models/resnet101_128_sigmoid_Nonlinearty_pretrain_VIPPGeo/221011-1211/ckpts/epoch_94.ckptt"),
