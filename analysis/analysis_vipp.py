...
#python3 analysis_vipp.py --test_city New_york --database_city New_york
#python3 analysis_vipp.py --test_city Shanghai --database_city Shanghai
#python3 analysis_vipp.py --test_city Tokyo --database_city Tokyo
#python3 analysis_vipp.py --test_city London --database_city London
